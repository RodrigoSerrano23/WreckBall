 ...
 * @author el_jr
 */
public class Automata extends javax.swing.JDialog {

    /**
     * Creates new form Automata
     */
    PrincipalCompi padre;
    public Automata(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Automata dialog = new Automata(new javax.swing.JFrame(), true);
